...
public class SelectLocalImportModel {
    ...
    public static Drawable[] getimage(Context mcontext) {
        Drawable[] title_Array = new Drawable[]{
                ContextCompat.getDrawable(mcontext, R.drawable.conimport),
                ContextCompat.getDrawable(mcontext, R.drawable.conloasl),
                ContextCompat.getDrawable(mcontext, R.drawable.bioimport),
                ContextCompat.getDrawable(mcontext, R.drawable.bioimport)
        };
        return title_Array;
    }
    ...
    public static Drawable[] getIndicatorDrawable(Context mcontext) {
        Drawable[] titleArray = new Drawable[]{
                ContextCompat.getDrawable(mcontext, R.drawable.socio_economique_icon),
                ContextCompat.getDrawable(mcontext, R.drawable.socio_ecologique_icon),
                ContextCompat.getDrawable(mcontext, R.drawable.socio_culturel_icon),
                ContextCompat.getDrawable(mcontext, R.drawable.socio_politique_icon)
        };
//        return titleArray;
        return null;
    }
